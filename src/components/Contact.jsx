...
const Contact = () => {
  ...
  return (
    <section id="kontak" className="relative py-20 md:py-32 overflow-hidden">
      <div className="absolute inset-0 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950"></div>
      
      <div className="absolute top-1/4 right-0 w-96 h-96 bg-esta-500/10 rounded-full blur-3xl"></div>
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="lg:col-span-1 space-y-6">
            {contactInfo.map((info, index) => (
              <div
                key={index}
                className="glass-card rounded-xl p-6 hover:bg-white/10 transition-all duration-300 animate-fadeInUp"
            ...
            <div className="glass-card rounded-xl p-6 animate-fadeInUp" style={{ animationDelay: '0.3s' }}>
          ...
          <div className="lg:col-span-2">
            <form onSubmit={handleSubmit} className="glass-card rounded-2xl p-8 md:p-10 animate-fadeInUp" style={{ animationDelay: '0.2s' }}>
              ...
              <button
                type="submit"
                className="w-full px-8 py-4 bg-gradient-to-r from-esta-500 to-esta-600 hover:from-esta-600 hover:to-esta-700 rounded-xl font-semibold text-white transition-all duration-300 shadow-lg shadow-esta-500/30 hover:shadow-esta-500/50 hover:scale-105 flex items-center justify-center gap-2"
              >
